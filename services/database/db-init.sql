...
-- Generation Time: Jan 24, 2021 at 10:13 PM
...
(265, 2, 0, 'cracker', 1, 1),
(266, 2, 0, 'hacker', 1, 1),
(267, 2, 0, 'attacker', 1, 1),
(268, 3, 0, 'mouse', 1, 1),
(269, 3, 0, 'click', 1, 1),
(270, 3, 1, 'keyboard', 1, 1),
(271, 3, 1, 'type', 1, 1),
(275, 33, 0, 'p = v × i', 0, 1),
(276, 33, 0, 'p = v ÷ i', 0, 1),
...
(82, 30, 0, 82, 'Use More Efficient Pump Control', 61, '2020-07-01 18:19:29', 0),
(83, 30, 0, 83, 'Reduce Flow Required', 51, '2020-07-01 21:21:37', 0),
(84, 30, 0, 84, 'Reduce Head Required', 51, '2020-07-01 21:28:45', 0),
(85, 30, 0, 85, 'Improve Pump Efficiency', 61, '2020-07-01 21:42:32', 0),
...
(281, 78, 0, 281, 'Error Checking', 58, '2021-01-22 21:34:11', 0),
(283, 80, 0, 283, 'Error Checking', 42, '2021-01-23 08:45:21', 0);
...
(55, 'Julian Peter', 'Energy Analyst', 'Environmental engineering major.', '/uploads/user_55/fc3438b2cc7a28a374d05d4442da8295.jpg', 10, 1),
...
(1973, 107, 0, 1, 31, 'Notched V-belts have grooves perpendicular to the length of the belt to reduce bending resistance. ', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-07-03 03:12:11', 1),
...
(1988, 107, 0, 1, 31, 'Synchronous drives use toothed belts and mated grooved sprockets to transfer power rather than friction. Synchronous belt drives operate more efficient and require less maintenance than V-belt drives.', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-07-03 03:12:11', 1),
...
(4995, 156, 0, 0, 31, 'This meeting is analogous to the what the OSU IAC has traditionally called the \"Pre-Audit Walkthrough Phone Call\" (excluding site visit logistics, safety and PPE discussion)', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-09-03 20:03:28', 1),
...
(5505, 206, 0, 0, 31, 'When creating pages or cards there are two methods for adding images:', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-09-09 22:17:03', 0),
...
(6830, 156, 0, 0, 31, 'This meeting is analogous to the what the OSU IAC has traditionally called the \"Pre-Audit Walkthrough Phone Call\" (excluding site visit logistics, safety and PPE discussion)', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-11-20 21:21:53', 0),
...
(6911, 77, 0, 1, 31, 'Reducing the inlet air temperature of oil-injected screw compressors increases mass flow rate while maintaining power input. To efficiently maintain current mass flow rate a variable frequency drive is required to reduce the motor speed and associated power.', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-11-27 06:07:10', 0),
...
(6926, 77, 0, 1, 31, 'Insufficient receiver capacity can result in short cycling in oil-injected rotary screw compressors that use load-unload controls. Short cycling occurs when system demand forces a compressor to re-load before unload power has been fully realized, causing the compressor to cycle too frequently. Adding receiver capacity increases system efficiency by reducing cycling losses and time spent at partial loads. ', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-11-27 06:07:10', 0),
...
(7661, 107, 0, 0, 11, 'Replace standard efficiency motors with NEMA premium efficiency motors', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7662, 107, 0, 1, 10, 'Standard efficiency motors used in high energy consumer applications ', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7663, 107, 0, 0, 11, 'Replace oversized motors', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7664, 107, 0, 1, 31, '<p>It is common for a facility to choose an oversized motor as a conservative measure. Motors consume the least amount of energy when they operate at their highest efficiency. For most motors, this is from 75% to 110% of their rated load. As motor loading drops below 50%, the efficiency and power factor drops rapidly. </p>', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7665, 107, 0, 1, 10, 'Motor consistently operating at less than half of full load', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7666, 107, 0, 1, 15, 'Power measurements (kW) to determine motor loading is preferred over amperage reading because they take into account the changes in power factor and amperage that occur as the motor loading changes', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7667, 107, 0, 0, 11, 'Replace Standard V-Belts with Notched V-Belts', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7668, 107, 0, 1, 31, 'Notched V-belts have grooves perpendicular to the length of the belt to reduce bending resistance. ', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7669, 107, 0, 1, 10, 'Numerous belt-driven motors are used throughout a facility ', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7670, 107, 0, 1, 3, 'Notched V-belts are approximately 2% more efficient than standard belts. The OSU EEC uses 1.5% as a conservative estimate.', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7671, 107, 0, 1, 14, 'Are V-belts or synchronous belts more suited to the application?', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7672, 107, 0, 1, 1, 'Run cooler, last longer, and are more efficient than standard V-belts', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7673, 107, 0, 1, 1, 'Don\'t require retrofits if standard V-belts are already used', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7674, 107, 0, 1, 1, 'More suitable than synchronous drives if vibrational damping is needed or the application causes sudden torque changes', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7675, 107, 0, 1, 2, 'Sharp efficiency reduction at high torque due to increased slippage', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7676, 107, 0, 1, 2, 'Like standard V-belts, notched belts degrade in efficiency over time if not properly maintained', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7677, 107, 0, 1, 2, 'V-belts may perform worse in dirty environments than synchronous belts', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7678, 107, 0, 1, 12, 'Incrementally install notched V-belts as old belts are replaced.', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7679, 107, 0, 1, 7, 'Regular scheduled maintenance and re-tensioning ', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7680, 107, 0, 1, 20, '', 'https://drive.google.com/file/d/1uk3x2VpKQ9FrRUOvU4nQ9U2zHfQsBXGC/view?usp=sharing', 'Thermal Image of Notched vs Standard V-belt', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7681, 107, 0, 1, 21, 'An OSU EEC Analysis Template in Microsoft Excel Format', 'https://drive.google.com/file/d/19tm7mcwn9jYIj_xDkJ7Ki9buPw0gc2Kl/view?usp=sharing', 'Install Notched V-Belts Template', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7682, 107, 0, 0, 11, 'Replace V-Belt Drives with Synchronous Belt Drives ', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7683, 107, 0, 1, 31, 'Synchronous drives use toothed belts and mated grooved sprockets to transfer power rather than friction. Synchronous belt drives operate more efficient and require less maintenance than V-belt drives.', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7684, 107, 0, 1, 10, 'Numerous belt-driven motors are used throughout a facility ', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7685, 107, 0, 1, 3, 'Synchronous drives consistently operate with 98% efficiency', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7686, 107, 0, 1, 14, 'Are V-belts or synchronous belts more suited to the application?', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7687, 107, 0, 1, 1, 'Maintain efficiency over a wide load range', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7688, 107, 0, 1, 1, 'Work well in oily and wet environments', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7689, 107, 0, 1, 1, 'Require minimal maintenance and re-tensioning ', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7690, 107, 0, 1, 2, 'Require installation of mating grooved sprockets', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7691, 107, 0, 1, 2, 'Noisier and transfer more vibration than V-belts', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7692, 107, 0, 1, 2, 'Vulnerable to sudden torque changes that can shear the belt\'s teeth', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7693, 107, 0, 1, 12, 'Consider consulting a power transmission specialist to determine viability and savings potential from retrofitting V-belt drives with synchronous belts. Install notched belts where synchronous are not cost effective.', '', '', 0, 0, 0, 0, '2020-12-17 03:38:04', 0),
(7747, 85, 0, 0, 31, '<p>Pump efficiency is very dependent upon flow and pressure, and the pump\'s operating characteristics. For a given rpm there is one optimal operating point of flow and pressure. As the pressure changes, flow changes and operating efficiency is also affected. If system conditions have changed since the initial selection of the pump then it may be operating at a higher rpm than is required, therefore wasting energy. An oversized pump often works continuously against a throttle causing even greater inefficiencies. </p>', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7748, 85, 0, 0, 8, 'If a pump is oversized to handle the variable flow requirements then see the recommendation for more efficient controls ', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7749, 85, 0, 0, 11, 'Trim Pump Impeller for Better Efficiency at Typical Operating Points', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7750, 85, 0, 0, 31, '<p>A pump\'s operating characteristics can be adjusted by re-sizing the impeller. On a given system, it may be possible to achieve greater efficiency with a different pump impeller.</p>', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7751, 85, 0, 0, 11, 'Replace Pump with One Selected for Optimum Efficiency at Typical Operating Points', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7752, 85, 0, 1, 10, 'Older pumps that have not been adjusted or calibrated to fit existing demand.', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7753, 85, 0, 1, 15, 'Pressure across the pump', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7754, 85, 0, 1, 15, 'Fluid flow rate', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7755, 85, 0, 1, 15, 'Operating hours', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7756, 85, 0, 1, 15, 'Pump curve and nameplate', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7757, 85, 0, 1, 15, 'Elevation change', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7758, 85, 0, 1, 15, 'Type of fluid', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7759, 85, 0, 1, 27, 'Power Quality Analyzer (PQA)', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7760, 85, 0, 1, 27, 'Ultrasonic flow meter', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7761, 85, 0, 1, 8, 'Try to find nearby pressure gauges to estimate pressure change across the pump.', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7762, 85, 0, 1, 8, 'Pick a pump based on its best efficiency point matching current operating conditions.', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7763, 85, 0, 1, 14, 'Would installing a variable frequency drive (VFD), trimming the impeller, replacing the motor, or using a belt sheave be a better option?', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7764, 85, 0, 1, 4, 'When modifying or replacing pumps and fans, or adjusting their rpm, be sure that they can operate under all conditions anticipated for the given system. System pressure or head should not exceed the maximum pressure or head the fan or pump can sustain. Surge points should be avoided.', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7765, 85, 0, 0, 11, 'Replace or Overhaul Worn or Damaged Pumps', '', '', 0, 0, 0, 0, '2020-12-18 17:13:04', 0),
(7766, 82, 0, 0, 31, '<p>On of the most common and inefficient methods to control a pump is to restrict its flow. As the pressure is increased the flow is reduced. However, work required to deliver the reduced flow is greater than would otherwise be required. </p>', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7767, 82, 0, 0, 8, 'If pump is oversized and flow is constantly at a reduced level see recommendations improving pump efficiency by using an optimally sized pump.', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
...
(7775, 82, 0, 1, 4, 'Networks with multiple pumps operating in parallel or series need to be carefully considered before recommending VFD control', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7776, 82, 0, 1, 4, 'For high static head conditions (pumping to high pressure vessel or high elevation tank) take care in evaluating pump operation with VFD control.  Pumps can be forced into low efficiency, high wear conditions with inappropriate high static head VFD control.', '', '', 1, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7777, 82, 0, 1, 4, 'VFDs can harm the motor if they are not properly installed', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7778, 82, 0, 1, 7, 'Install grounding shaft to divert VFD induced voltages away from the motor', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7779, 82, 0, 1, 15, 'Pump nameplate/motor nameplate', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7780, 82, 0, 1, 15, 'Flow rates, pressure readings, live amperage data', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7781, 82, 0, 1, 17, 'An OSU EEC Analysis Template in Microsoft Excel Format', 'https://oregonstate.app.box.com/file/606303033065', 'Analysis Template: Install VFDs on Process Pumps', 2, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7782, 82, 0, 0, 11, 'Eliminate Bypass Control', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7783, 82, 0, 0, 31, '<p>Bypass controls can be an extremely inefficient method for controlling flow. In the best case, pump energy use is constant regardless of required flow. In the worst case, energy used increases with reduced flow. In this case a reduction in flow requires more energy to recirculate the diverted fluid and does not add any value to the finished product. </p>', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
(7784, 82, 0, 0, 11, 'Replace On/Off Control with Continuous Flow Control ', '', '', 0, 0, 0, 0, '2020-12-18 17:15:24', 0),
...
(7799, 90, 0, 0, 4, 'Boilers can be bombs if not properly set up and maintained.', '', '', 0, 0, 0, 0, '2020-12-18 18:36:17', 0),
(7800, 90, 0, 1, 23, 'M5 Industries founder shows potential damages due to safety system failure', 'https://www.youtube.com/watch?v=jbreKn4PoAc', 'Boiler system failure', 1, 1, 0, 0, '2020-12-18 18:36:17', 0),
(7801, 91, 0, 0, 3, '1 boiler horsepower (BoHP) = 33,479 Btu/hr', '', '', 0, 0, 0, 0, '2020-12-18 18:38:14', 0),
(7802, 91, 0, 0, 3, 'Exhaust gases are typically best kept above 300 °F to avoid corrosive condensation.', '', '', 0, 0, 0, 0, '2020-12-18 18:38:14', 0),
(7803, 91, 0, 0, 3, 'Ideal exhaust temperatures should not be more than 100 - 150 °F greater than the steam temperature. If a boiler is well designed and heat exchanger surfaces are in good condition, ideal exhaust temperatures should be achievable.', '', '', 0, 0, 0, 0, '2020-12-18 18:38:14', 0),
(7804, 91, 0, 0, 3, 'For every 40°F decrease in flue gas temperature there is a 1% increase in efficiency', '', '', 0, 0, 0, 0, '2020-12-18 18:38:14', 0),
(7805, 95, 0, 0, 15, 'Boiler Nameplate Data', '', '', 0, 0, 0, 0, '2020-12-18 18:40:35', 0),
(7806, 95, 0, 1, 26, ' Rated Capacity (Steam Production, Maximum Fuel Input)', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7807, 95, 0, 1, 26, 'Fan Horsepower', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7808, 95, 0, 1, 26, 'Make, Model, Serial Number', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7809, 95, 0, 0, 15, 'Combustion Analysis: ', '', '', 0, 0, 0, 0, '2020-12-18 18:40:35', 0),
(7810, 95, 0, 1, 26, 'Stack Temperature', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7811, 95, 0, 1, 26, 'Excess O2', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7812, 95, 0, 1, 26, ' Inlet / Ambient Temperature ', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7813, 95, 0, 0, 15, 'Capacity over time', '', '', 0, 0, 0, 0, '2020-12-18 18:40:35', 0),
(7814, 95, 0, 1, 26, 'Hourly steam production', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7815, 95, 0, 1, 26, 'Hourly energy use', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
(7816, 95, 0, 1, 8, 'Sometimes capacity must be inferred from fan energy, and characteristic fan energy curves', '', '', 0, 0, 0, 0, '2020-12-18 18:40:35', 0),
(7817, 95, 0, 0, 15, 'Fuel used', '', '', 0, 0, 1, 0, '2020-12-18 18:40:35', 0),
...
(7975, 119, 0, 1, 1, 'No cost option', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7976, 119, 0, 1, 2, 'This measure is only as reliable as the operators', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7977, 119, 0, 0, 11, 'Operate equipment in batches rather than continuously ', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7978, 119, 0, 1, 1, 'No cost option', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7979, 119, 0, 1, 2, 'Batch processing also has potential for increasing demand charges if the equipment is more heavily loaded.', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7980, 119, 0, 0, 11, 'Interlock equipment with a related process', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7981, 119, 0, 1, 31, '<p>If a particular piece of equipment is dedicated to specific process that requires additional equipment, they can all be interlocked so all will be de-energized when the operator turns off one piece of equipment.</p>', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7982, 119, 0, 1, 1, 'More reliable then having operators turn of multiple pieces of equipment', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7983, 119, 0, 0, 11, 'Automatically control equipment operation time', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7984, 119, 0, 0, 31, '<p>Timers, level sensors, material sensors, and other controls can be used to automatically turn off equipment that is not currently being utilized and automatically turn on when needed.</p>', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7985, 119, 0, 0, 1, 'Can obtain efficiencies of batch processing automatically', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7986, 119, 0, 0, 4, 'Special care must be taken to avoid creating a safety hazard', '', '', 0, 0, 0, 0, '2020-12-19 00:46:45', 0),
(7987, 125, 0, 0, 20, '', '/uploads/user_55/215ed3c31cbc4dec9d0ffcdc21ee5a39.jpg', 'Sample Pump Curve', 0, 0, 0, 0, '2020-12-19 00:48:12', 0),
(7988, 125, 0, 0, 20, '', '/uploads/user_55/83a92c72662cbec1f08d0c7686c6af33.jpg', 'Sample Pump Nameplate', 0, 0, 0, 0, '2020-12-19 00:48:12', 0),
...
(7991, 96, 0, 0, 27, 'Combustion Analyzer ', '', '', 0, 0, 0, 0, '2020-12-19 18:59:16', 0),
(7992, 96, 0, 0, 27, 'Digital or Infrared Thermometer', '', '', 0, 0, 0, 0, '2020-12-19 18:59:16', 0),
(7993, 96, 0, 0, 8, 'An IR camera can help identify hot spots to insulate', '', '', 0, 0, 0, 0, '2020-12-19 18:59:16', 0),
...
(8007, 101, 0, 0, 11, 'Tune the boiler regularly', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
...
(8017, 101, 0, 1, 12, 'Clean the water side. Scale can accumulate and inhibit heat transfer is the water chemistry is off', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8018, 101, 0, 0, 11, 'Install an economizer', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8019, 101, 0, 1, 10, 'Boilers rated at 100 BoHP or higher operating at greater than 75 psig.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8020, 101, 0, 1, 31, 'Economizers can be used to preheat incoming feedwater, reducing the energy required for boiling.', '%zXz%', '%zXz%', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8021, 101, 0, 1, 3, 'Typically increases efficiency by around 2-4%.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8022, 101, 0, 1, 3, 'For every 40°F decrease in flue gas temperature there is a 1% increase in efficiency', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8023, 101, 0, 1, 3, 'Can often reduce fuel requirements by 10%', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8024, 101, 0, 1, 8, 'Best suited for boilers with flue gasses containing sulfur or other potentially acidic elements/compounds.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8025, 101, 0, 1, 4, 'Flue gasses containing sulphur must remain above dew point. Condensation of sulphuric acid can cause corrosion and damage the system.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8026, 101, 0, 1, 2, 'Cannot recover as much energy from the boiler stack as a condensing economizer.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8027, 101, 0, 1, 14, 'Does the boiler contain potentially acidic elements/compounds such as sulfur?', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8028, 101, 0, 1, 14, 'Would a condensing economizer be a better alternative?', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8029, 101, 0, 1, 14, 'Is there adequate space for an economizer?', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8030, 101, 0, 1, 14, 'What is the greatest temperature that the flue gasses can be reduced by without causing condensation?', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8031, 101, 0, 1, 27, 'Combustion analyzer', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8032, 101, 0, 1, 15, 'Flue gas temperature', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8033, 101, 0, 1, 15, 'Fuel used', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8034, 101, 0, 1, 15, 'Operating hours', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8035, 101, 0, 1, 15, 'Water mass flowrate', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8036, 101, 0, 1, 15, 'Water temperatures', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8037, 101, 0, 1, 15, 'Steam temperature and pressure', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8038, 101, 0, 1, 15, 'Boiler efficiency', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8039, 101, 0, 1, 17, 'Department of Energy tip sheet that provides an example case study of a boiler feedwater economizer being installed, as well as general considerations.', 'https://www.energy.gov/sites/prod/files/2014/05/f16/steam3_recovery.pdf', 'Use Feedwater Economizers for Waste Heat Recovery', 1, 0, 0, 0, '2020-12-20 02:03:19', 0),
(8040, 101, 0, 0, 11, 'Install a condensing economizer', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8041, 101, 0, 1, 10, 'Boilers rate at 100 BoHP or higher operating at greater that 75 psig that do not user fuels with sulphurous products.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8042, 101, 0, 1, 3, 'Can increase efficiency by up to 10%', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8043, 101, 0, 1, 3, 'Can increase boiler efficiency to over 90%', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8044, 101, 0, 1, 1, 'Can recover more energy from the boiler stack by reducing flue gas temperature below dew point.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8045, 101, 0, 1, 2, 'Not recommended for use with fuels containing sulphur.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8046, 101, 0, 1, 2, 'The condensed water may be acidic, requiring treatment before being disharged to sewer systems.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8047, 101, 0, 1, 4, 'Fuels with sulphurous combustions can damage the boiler stack when condensing, creating sulphuric acid.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8048, 101, 0, 1, 4, 'Boiler stacks are prone to corrosion due to water condensation.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0);
INSERT INTO `Items` (`itemId`, `cardId`, `orderIndex`, `indentation`, `iconType`, `contentText`, `contentUrl`, `contentLabel`, `contentMode`, `internal`, `inline`, `sourceId`, `created`, `approved`) VALUES
(8049, 101, 0, 1, 14, 'Does the boiler\'s fuel contain potentially acidic elements/compounds such as sulfur?', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8050, 101, 0, 1, 14, 'What is the greatest temperature the flue gasses can be reduced by?', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8051, 101, 0, 1, 27, 'Combustion analyzer', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8052, 101, 0, 1, 15, 'Flue gas temperature', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8053, 101, 0, 1, 15, 'Flue gas composition', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8054, 101, 0, 1, 15, 'Fuel used', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8055, 101, 0, 1, 15, 'Operating hours', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8056, 101, 0, 1, 15, 'Water mass flowrate', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8057, 101, 0, 1, 15, 'Water temperatures', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8058, 101, 0, 1, 15, 'Steam temperature/pressure', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8059, 101, 0, 1, 15, 'Boiler efficiency', '', '', 0, 0, 1, 0, '2020-12-19 19:14:38', 0),
(8060, 101, 0, 1, 12, 'Complete a more in-depth study evaluating the benefits of a condensing economizer and how it may impact the water and how the boiler operates.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8061, 101, 0, 1, 12, 'Contact a vendor for more implementation details. Condensing economizers are custom made for each boiler.', '', '', 0, 0, 0, 0, '2020-12-19 19:14:38', 0),
(8062, 101, 0, 1, 24, 'This webpage lists the epcific heats and gas constants for different gasses. This is uesd for calculating the properties of the flue gasses.', 'https://www.engineeringtoolbox.com/specific-heat-capacity-gases-d_159.html', 'Specific Heat and Individual Gas Constant of Gases', 1, 0, 0, 0, '2020-12-20 02:03:54', 0),
(8063, 101, 0, 1, 17, 'Department of Energy tip sheet that explains how a condensing economizer works and how it saves energy, along with example scenarios', 'https://www.energy.gov/sites/prod/files/2014/05/f16/steam26a_condensing.pdf', 'Consider Installing a Condensing Economizer', 1, 0, 0, 0, '2020-12-20 02:03:46', 0),
(8064, 101, 0, 1, 17, 'Department of Energy tip sheet that explains special considerations that need to be taken into account when choosing to do projects with condensing economizers.', 'https://www.energy.gov/sites/prod/files/2014/05/f16/steam26b_condensing.pdf', 'Considerations When Selecting a Condensing Economizer', 1, 0, 0, 0, '2020-12-20 02:03:51', 0),
(8083, 99, 0, 0, 22, 'An OSU EEC Google Slideshow', 'https://docs.google.com/presentation/d/1A-bLNUv7hCuBV2zMsS0A4JEKPNVxaKnIwUMoVZCFr2w/edit?usp=sharing', 'Steam Systems', 0, 0, 0, 0, '2020-12-19 19:21:00', 0),
(8084, 99, 0, 0, 17, 'An OSU EEC Appendix in Microsoft Word Format', 'https://drive.google.com/file/d/1Jh6CaIDd6ugCo6FYqviyVK-O49ic_275/view?usp=sharing', 'Combustion Appendix', 0, 0, 0, 0, '2020-12-19 19:21:00', 0),
...
(8118, 106, 0, 0, 31, '<p>As the steam goes though the pipes it will lose energy to the surrounding environment. Although the pipes may be completely leak free, the effects of lost energy are the same as a leak. Insulating the steam system will require less fuel to get the necessary amount of steam to the end user. </p>', '', '', 1, 0, 0, 0, '2020-12-19 19:41:55', 0),
(8119, 106, 0, 0, 10, 'Exposed pipes, valves, or fittings', '', '', 1, 0, 0, 0, '2020-12-19 19:41:55', 0),
(8120, 106, 0, 0, 11, 'Insulate steam lines', '', '', 0, 0, 0, 0, '2020-12-19 19:41:55', 0),
(8121, 106, 0, 0, 11, 'Insulate valves and fittings', '', '', 0, 0, 0, 0, '2020-12-19 19:41:55', 0),
(8122, 106, 0, 0, 11, 'Insulate condensate lines', '', '', 0, 0, 0, 0, '2020-12-19 19:41:55', 0),
(8123, 106, 0, 0, 21, 'An OSU EEC Analysis Template in Microsoft Excel Format', 'https://drive.google.com/file/d/1Et50Qc77pWtPkZcorKcPG_RSuK-Vc_lx/view?usp=sharing', 'Insulation Template  (almost approved)', 0, 1, 0, 0, '2020-12-19 19:41:55', 0),
(8124, 106, 0, 0, 21, 'North American Insulation Manufacturers Association Software Download', 'https://insulationinstitute.org/tools-resources/free-3e-plus/?cn-reloaded=1', 'NAIMA 3E Plus Insulation Tool', 1, 0, 0, 0, '2020-12-20 02:05:59', 0),
(8133, 100, 0, 0, 24, 'See steam tip sheets', 'https://www.energy.gov/eere/amo/tip-sheets-system', 'U.S.DOE Energy Tip Sheets by System', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
(8134, 100, 0, 0, 17, 'United Nations Industrial Development Organization Document', 'https://www.unido.org/sites/default/files/2017-11/SSO-Manual-Print-FINAL-20161109-One-Page-V2.pdf', 'Manual for Industrial Steam Systems Assessment and Optimization', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
(8135, 100, 0, 0, 25, 'Pacific NW Boiler Vendor', 'https://coleindust.com/', 'Cole Industrial', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
(8136, 100, 0, 0, 25, 'Pacific NW Boiler Vendor', 'https://www.nationwideboiler.com/pacific-combustion-engineering.html', 'Pacific Combustion Engineering', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
(8137, 100, 0, 0, 25, 'Boiler Manufacturer', 'http://cleaverbrooks.com/', 'CleaverBrooks', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
(8138, 100, 0, 0, 24, 'TLV Steam Theory site. Contains several pages that explain steam systems and equations.', 'https://www.tlv.com/global/US/steam-theory/how-to-read-a-steam-table.html', 'TLV Steam Theory\nHow to read a Steam Table', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
(8139, 100, 0, 0, 24, 'Engineering Toolbox, Complete steam tables with options for converting units', 'https://www.engineeringtoolbox.com/saturated-steam-properties-d_273.html', 'Steam Table', 1, 0, 0, 0, '2020-12-20 02:02:40', 0),
...
(11466, 270, 0, 0, 26, '<p>Approach Temperature</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11467, 270, 0, 1, 31, '<p>Temperature difference between the liquid/gas in the heat exchanger as it exists compared with the surrounding medium that serves as a heat source or sink.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11468, 270, 0, 0, 26, 'Compressor Work', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11469, 270, 0, 1, 31, '<p>Heat exchanger in which the refrigerant absorbs energy from its surroundings and changes from a liquid to a gas.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11470, 270, 0, 0, 26, 'Condenser', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11471, 270, 0, 1, 31, '<p>Change in enthalpy as the refrigerant is compressed.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11472, 270, 0, 0, 26, 'Cooling Effect', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11473, 270, 0, 1, 31, '<p>Heat exchanger in which refrigerant gives off energy to its surroundings and condenses from a gas to a liquid.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11474, 270, 0, 0, 26, 'Discharge, Condensing, High-side Pressure', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11475, 270, 0, 1, 31, '<p>Change in enthalpy in the evaporator as the refrigerant absorbs energy and changes from a liquid to a gas.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11476, 270, 0, 0, 26, 'Enthalpy', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11477, 270, 0, 1, 31, '<p>Pressure at the compressor discharge at which the refrigerant condenses. Condensing pressure fluctuates with outside temperatures in air-cooled or evaporative units.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11478, 270, 0, 0, 26, 'Evaporator', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11479, 270, 0, 1, 31, '<p>Enthalpy is sometimes called total energy because it includes internal energy (U), the work done in a particular process (pV), and change of phase.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11480, 270, 0, 0, 26, 'Latent Heat of Vaporization', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11481, 270, 0, 1, 31, '<p>Approach temperature difference across a heat exchanger with the heat transfer coefficient maximized. This can be measured for clean condensers or evaporators with all heat exchange fans running at full power.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11482, 270, 0, 0, 26, 'Minimum Approach Temperature Difference (MATD)', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11483, 270, 0, 1, 31, '<p>Air-cooled and evaporative condensers control the maintain minimum discharge pressure by cycling fans or controlling speed. Plant personnel control the minimum pressure set point.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11484, 270, 0, 0, 26, 'Minimum Discharge Pressure', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11485, 270, 0, 1, 31, '<p>The refrigerant is the \"working fluid\" which evaporates to absorb the latent heat of vaporization from its surroundings, thereby cooling its surroundings. To permit refrigerant to operate continuously, the refrigerant vapor is compressed and reconverted to liquid effectively moving energy from where the refrigerant vaporizes to where it condenses.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11486, 270, 0, 0, 26, 'Refrigerant', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11487, 270, 0, 1, 31, '<p>Change in enthalpy as the refrigerant condenses.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11488, 270, 0, 0, 26, 'Rejected Heat', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11489, 270, 0, 1, 31, '<p>Change in enthalpy as the refrigerant evaporates from a saturated liquid to a saturated vapor at a specified pressure.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11490, 270, 0, 0, 26, 'Suction, Low-side Pressure', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11491, 270, 0, 1, 31, '<p>Pressure at the inlet to the compressor is also the pressure at which the refrigerant evaporates.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11492, 270, 0, 0, 26, 'Tons', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11493, 270, 0, 1, 31, '<p>A measure of the cooling capacity usually applied to larger cooling systems and heat pumps. One ton of cooling represents the ability to absorb energy at a rate originally determined by melting one short ton (2,000 lbs) of ice in 24 hours. Now, 1 ton = 12,000 Btu/hr = 3.52 kW.</p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11494, 270, 0, 0, 31, '<p><strong>Approach Temperature﻿</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11495, 270, 0, 1, 26, 'Temperature difference between the liquid/gas in the heat exchanger as it exists compared with the surrounding medium that serves as a heat source or sink.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11496, 270, 0, 0, 31, '<p><br></p><p><strong>Condenser﻿</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11497, 270, 0, 1, 26, 'Heat exchanger in which refrigerant gives off energy to its surroundings and condenses from a gas to a liquid.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11498, 270, 0, 0, 31, '<p><br></p><p><strong>Cooling Effect</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11499, 270, 0, 1, 26, 'Change in enthalpy in the evaporator as the refrigerant absorbs energy and changes from a liquid to a gas.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11500, 270, 0, 0, 31, '<p><br></p><p><strong>Compressor Work</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11501, 270, 0, 1, 26, 'Change in enthalpy as the refrigerant is compressed.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11502, 270, 0, 0, 31, '<p><br></p><p><strong>Discharge, Condensing, High-side Pressure</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11503, 270, 0, 1, 26, 'Pressure at the compressor discharge at which the refrigerant condenses. Condensing pressure fluctuates with outside temperatures in air-cooled or evaporative units.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11504, 270, 0, 0, 31, '<p><br></p><p><strong>Enthalpy</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11505, 270, 0, 1, 26, 'Enthalpy is sometimes called total energy because it includes internal energy (U), the work done in a particular process (pV), and change of phase.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11506, 270, 0, 0, 31, '<p><br></p><p><strong>Evaporator</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11507, 270, 0, 1, 26, 'Heat exchanger in which the refrigerant absorbs energy from its surroundings and changes from a liquid to a gas.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11508, 270, 0, 0, 31, '<p><br></p><p><strong>Latent Heat of Vaporization</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11509, 270, 0, 1, 26, 'Change in enthalpy as the refrigerant evaporates from a saturated liquid to a saturated vapor at a specified pressure.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11510, 270, 0, 0, 31, '<p><br></p><p><strong>Minimum Approach Temperature Difference (MATD)</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11511, 270, 0, 1, 26, 'Approach temperature difference across a heat exchanger with the heat transfer coefficient maximized. This can be measured for clean condensers or evaporators with all heat exchange fans running at full power.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11512, 270, 0, 0, 31, '<p><br></p><p><strong>Minimum Discharge Pressure</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11513, 270, 0, 1, 26, 'Air-cooled and evaporative condensers control the maintain minimum discharge pressure by cycling fans or controlling speed. Plant personnel control the minimum pressure set point.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11514, 270, 0, 0, 31, '<p><br></p><p><strong>Refrigerant</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11515, 270, 0, 1, 26, 'The refrigerant is the \"working fluid\" which evaporates to absorb the latent heat of vaporization from its surroundings, thereby cooling its surroundings. To permit refrigerant to operate continuously, the refrigerant vapor is compressed and reconverted to liquid effectively moving energy from where the refrigerant vaporizes to where it condenses.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11516, 270, 0, 0, 31, '<p><br></p><p><strong>Rejected Heat</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11517, 270, 0, 1, 26, 'Change in enthalpy as the refrigerant condenses.', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
(11518, 270, 0, 0, 31, '<p><br></p><p><strong>Suction, Low-side Pressure</strong></p>', '', '', 0, 0, 0, 0, '2021-01-13 20:29:46', 0),
...
(11944, 278, 0, 0, 31, '<p>[Optional opportunity category summary]</p><p>In most cases, related opportunities may be grouped together by a common theme usually related to the avenue through which energy is saved. For example, in refrigeration systems, reducing the compressor power is a common mode of energy savings and there are numerous actions that can be taken to achieve this effect.</p><p></p><p>Below is the suggested order of descriptions, items, graphics, and resources to include. Feel free to deviate where it makes sense and don\'t feel the need to use every icon available. </p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11945, 278, 0, 0, 11, '<p>Phrase the opportunity using an action statement like in an AR description (no closing punctuation) Ex.) Install an economizer, Upgrade to more efficient equipment, etc.</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11946, 278, 0, 1, 31, '<p>An optional opportunity summary is written using complete sentences. </p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11947, 278, 0, 1, 10, '<p>Opportunity items follow a bullet-list style format</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11948, 278, 0, 1, 3, '<p>Complete sentences with closing punctuation are not necessary although may be used.</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11949, 278, 0, 1, 7, '<p>Best Practice</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11950, 278, 0, 1, 1, '<p>Pros</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11951, 278, 0, 1, 2, '<p>Cons</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11952, 278, 0, 1, 4, '<p>Caveat</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11953, 278, 0, 1, 14, '<p>Question to ask</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11954, 278, 0, 1, 8, '<p>General tips may be added</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11955, 278, 0, 1, 27, '<p>Equipment </p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11956, 278, 0, 1, 27, '<p>Items may be added inline to create a horizontal list</p>', '', '', 0, 0, 1, 0, '2021-01-22 21:26:06', 0),
(11957, 278, 0, 1, 15, '<p>Standalone datum</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11958, 278, 0, 2, 8, '<p>Tips related to specific items may be added in this fashion</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11959, 278, 0, 1, 15, '<p>Related data may be categorized into bulleted lists</p>', '', '', 1, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11960, 278, 0, 2, 26, '<p>Related datum 1</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11961, 278, 0, 2, 26, '<p>Related datum 2</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11962, 278, 0, 2, 26, '<p>Related datum 3</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11963, 278, 0, 1, 12, '<p>Suggested action</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:26:06', 0),
(11964, 278, 0, 1, 17, '<p>Include graphics and resources at the end of an opportunity section.</p>', 'https://docs.google.com/document/d/1yDee1KpuIohxs36RELVCpm19-N96h4keDRt_eupD5Bw/edit?usp=sharing', '<p>EEC Writing Standards</p>', 1, 0, 0, 0, '2021-01-22 21:26:06', 0),
(12027, 281, 0, 0, 8, '<p>a</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:34:18', 0),
(12028, 281, 0, 0, 8, '<p>b</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:34:18', 0),
(12029, 281, 0, 0, 8, '<p>d</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:34:18', 0),
(12030, 281, 0, 0, 8, '<p>e</p>', '', '', 0, 0, 0, 0, '2021-01-22 21:34:18', 0),
(12076, 283, 0, 0, 8, '<p>a</p>', '', '', 0, 0, 0, 0, '2021-01-24 05:31:17', 0),
(12077, 283, 0, 0, 8, '<p>b</p>', '', '', 0, 0, 0, 0, '2021-01-24 05:31:17', 0),
(12078, 283, 0, 0, 8, '<p>c</p>', '', '', 0, 0, 0, 0, '2021-01-24 05:31:17', 0),
(12079, 283, 0, 0, 8, '<p>d</p>', '', '', 0, 0, 0, 0, '2021-01-24 05:31:17', 0);
...
(344, 21, 70, 'The request \"Thermal Systems - Heat Exchangers\" is awaiting an orange review', 2);
...
(2, 62, 'What do you call a person who is trying to steal important information from our organization electronically?', 2, 3, '', '2021-01-18 22:15:18', 1),
(3, 62, 'Can you name these two devices?', 3, 5, '/uploads/user_42/db309b887fde585de15cbacce2283779.jpg', '2021-01-18 22:15:17', 1),
...
(22, 'test', 'test', 4, '2021-01-18 22:14:13', 42);
...
(3, 0, 'Figures, Charts, and Tables', 29, 51, '2021-01-13 22:11:21'),
...
(91, 0, 'Rules of Thumb', 91, 61, '2020-12-18 18:38:14'),
(95, 0, 'Standard Data to Collect', 95, 61, '2020-12-18 18:40:35'),
(96, 0, 'Data Collection Equipment', 96, 61, '2020-12-19 18:59:16'),
(97, 10, 'Data Collection Guides', 97, 61, '2020-12-19 19:07:34'),
(98, 0, 'Analysis Tools', 98, 61, '2020-12-19 19:12:24'),
(99, 10, 'Internal Resources', 99, 61, '2020-12-19 19:12:55'),
(100, 0, 'Off Site Resource Links', 100, 61, '2020-07-03 17:55:16'),
(101, 0, 'Improve Boiler Combustion Efficiency', 101, 61, '2020-12-19 19:14:38'),
...
(106, 0, 'Reduce Heat Loss', 106, 61, '2020-07-03 17:31:09'),
(107, 0, 'Motor and Transmission Efficiency', 107, 61, '2020-12-17 03:38:04'),
(108, 0, 'Rules of Thumb', 108, 61, '2020-12-17 02:42:08'),
(119, 0, 'Turn off Motors (Consider Load Shedding)', 119, 61, '2020-12-17 03:08:44'),
...
--
ALTER TABLE `Cards`
  MODIFY `cardId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=284;
...
--
ALTER TABLE `History_Cards`
  MODIFY `historyId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `History_Items`
  MODIFY `historyId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=879;
...
--
ALTER TABLE `Items`
  MODIFY `itemId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12080;
