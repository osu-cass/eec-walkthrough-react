...
-- Generation Time: Jul 07, 2020 at 05:28 PM
...
INSERT INTO `Icons` (`iconType`, `typeKeyword`, `typeName`, `groupIndex`) VALUES
(1, 'Pros', 'plus', 1),
(2, 'Cons', 'minus', 1),
(3, 'Rules of Thumb', 'thumbs-up', 1),
(4, 'Caveats', 'skull', 1),
(5, 'Combustion', 'fire', 0),
(6, 'Electrical', 'bolt', 0),
(7, 'Best Practices', 'trophy', 1),
(8, 'Tips', 'hand-point-right', 1),
(9, 'Blueprint', 'map', 1),
(10, 'Opportunity Flag', 'flag', 1),
(11, 'Opportunity', 'check-square', 1),
(12, 'Suggested Action', 'square-full', 1),
(13, 'Opportunity Description', 'angle-right', 1),
(14, 'Question', 'question', 1),
(15, 'Data to Collect', 'pencil-alt', 1),
(16, 'File', 'file', 1),
(17, 'Document', 'copy', 3),
(18, 'Internal Link', 'info', 0),
(19, 'External Link', 'link', 0),
(20, 'Figure', 'chart-area', 2),
(21, 'Analysis Tool', 'list', 1),
(22, 'Slideshow', 'play', 3),
(23, 'Video', 'video-camera', 3),
(24, 'Informational Website', 'book', 3),
(25, 'Vendor Website', 'truck', 3),
(26, 'Bullet Point', 'circle', 1),
(27, 'Assessment Equipment', 'ruler-vertical', 1);
...
(2, 0, 'Compressed Air', 'Compressed air is a common utility found in most industrial facilities', 'Compressed air has been a key industrial utility since the 1800\'s. It can drive pneumatic cylinders, air motors, diaphragm pumps and controls. It is capable of reasonably high force actuation, and is a common required utility in equipment packages. It can be used and is often misused to generate air flow for agitation, blow-off, cooling, and motive force applications. Screw compressors currently comprise the majority of industrial compressed air installations, but reciprocating and centrifugal compressors can be found in older or special installations/applications.', '../images/aircompressor.png', 0, 56, '2020-06-29 19:15:43', 1),
